...
def usage_exam():
    ...
    print("\n")
    print("   EX)     python3 ALERT_main.py models(/GoogleNet/ResNet/...) cropping(cropO/cropX) sample_size N_shot adapt_iter exp_no your_memo tester")
    print("   EX)     python3 ALERT_main.py ISAViT cropO 500 5 10 1 test jp")
    print("\n")
    print("===============================================================================================================\n")
    sys.exit()
